...
const (
	...
	ErrFetcherJSNotFound = "cannot find ./phantomjs_fetcher.js or $GOPATH/github.com/src/bububa/ProxyPool/phantomjs/phantomjs_fetcher.js"
)
...
func (this *Fetcher) checkFetcherJS() (string, error) {
	...
	for _, path := range paths {
		fetcherJSPath := path + "/src/github.com/bububa/ProxyPool/phantomjs/phantomjs_fetcher.js"
		if this.exist(fetcherJSPath) {
			return fetcherJSPath, nil
		}
	}
